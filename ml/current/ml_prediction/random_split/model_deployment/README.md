...
**Model Version:** v1_20251123_073507  
**Created:** 2025-11-23 07:35:07  
...
```
model_deployment/
├── bilstm_model_v1_20251123_073507.keras          # Trained BiLSTM model
├── minmax_scaler_v1_20251123_073507.pkl           # Feature scaler
├── feature_metadata_v1_20251123_073507.json       # Feature specifications
├── performance_metrics_v1_20251123_073507.json    # Model performance stats
├── predict_v1_20251123_073507.py                  # Inference pipeline
└── README.md                                    # This file
```
...
|--------|-------|
| Test MAE | 10.63 days |
| Test RMSE | 24.75 days |
| Test R² | 0.5360 |
| Training Samples | 2819 orders |
| Test Samples | 705 orders |

**Interpretation:** On average, predictions are off by **10.6 days** for unseen clients.
...
```python
from predict_v1_20251123_073507 import ReorderPredictor
...
- Feature metadata: `feature_metadata_v1_20251123_073507.json`
- Performance metrics: `performance_metrics_v1_20251123_073507.json`

---

**Last Updated:** 2025-11-23 07:35:07
