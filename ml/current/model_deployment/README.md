...
**Model Version:** v1_20251123_120636  
**Created:** 2025-11-23 12:06:36  
...
```
model_deployment/
├── bilstm_model_v1_20251123_120636.keras          # Trained BiLSTM model
├── minmax_scaler_v1_20251123_120636.pkl           # Feature scaler
├── feature_metadata_v1_20251123_120636.json       # Feature specifications
├── performance_metrics_v1_20251123_120636.json    # Model performance stats
├── predict_v1_20251123_120636.py                  # Inference pipeline
└── README.md                                    # This file
```
...
| Test R² | 0.7154 |
| Training Samples | 2543 orders |
| Test Samples | 981 orders |

**Interpretation:** On average, predictions are off by **6.2 days** for unseen clients.
...
```python
from predict_v1_20251123_120636 import ReorderPredictor
...
- Feature metadata: `feature_metadata_v1_20251123_120636.json`
- Performance metrics: `performance_metrics_v1_20251123_120636.json`

---

**Last Updated:** 2025-11-23 12:06:36
