...
class ReorderPredictor:
    ...
    def __init__(self, model_dir="."):
        ...
        self.model = keras.models.load_model(f"{model_dir}/bilstm_model_v1_20251123_120636.keras")
        self.scaler = joblib.load(f"{model_dir}/minmax_scaler_v1_20251123_120636.pkl")
