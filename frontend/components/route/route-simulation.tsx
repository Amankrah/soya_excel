...
import { Truck, Play, Pause, RotateCcw, MapPin, Clock, User, Car, Video, Eye, Leaf, Fuel, TrendingDown, ChevronDown, ChevronUp, Lightbulb, TrendingUp, CheckCircle, Package, Repeat } from 'lucide-react';
...
export function RouteSimulation({ routeId, routeName: _routeName }: RouteSimulationProps) {
